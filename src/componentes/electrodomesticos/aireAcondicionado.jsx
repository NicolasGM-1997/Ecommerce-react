...
export function AireAcondicionado(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Aire Acondicionado</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/aire-acondicionado.png" producto="Aire-Acondicionado"
					  	color="Azul" key={index} valor={1750} descuento={33}/>
					))}
				</div>
			</div>
		</div>
