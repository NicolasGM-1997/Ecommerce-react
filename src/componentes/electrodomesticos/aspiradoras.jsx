...
export function Aspiradoras(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Aspiradoras</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/aspiradoras.png" producto="Aspiradoras"
					  	color="Azul" key={index} valor={1000} descuento={70}/>
					))}
				</div>
			</div>
		</div>
