...
export function Estufas(){
	return(
		<div className="contenedor">
			...
			<p className="tituloProducto">Estufas</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/estufas.png" producto="Estufas"
					  	color="Azul" key={index} valor={2100} descuento={45}/>
					))}
				</div>
			</div>
		</div>
