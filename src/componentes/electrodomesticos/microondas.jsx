...
export function Microondas(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Microondas</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/microondas.png" producto="Microondas"
					  	color="Azul" key={index} valor={1500} descuento={30}/>
					))}
				</div>
			</div>
		</div>
