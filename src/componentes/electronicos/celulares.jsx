...
export function Celulares(){
	return(
		<div className="contenedor">
			...
			<p className="tituloProducto">Celulares</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/celulares.png" producto="Celulares"
					  	color="Azul" key={index} valor={1900} descuento={27}/>
					))}
				</div>
			</div>
		</div>
