...
export function Computadores(){
	return(
		<div className="contenedor">
			...
			<p className="tituloProducto">Computadores</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/computadores.png" producto="Computadores"
					  	color="Azul" key={index} valor={3100} descuento={42}/>
					))}
				</div>
			</div>
		</div>
