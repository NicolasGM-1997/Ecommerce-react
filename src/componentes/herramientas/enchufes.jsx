...
export function Enchufes(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Enchufes</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/enchufes.png" producto="Enchufes"
					  	color="Azul" key={index} valor={4250} descuento={3}/>
					))}
				</div>
			</div>
		</div>
