...
export function Martillos(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Martillos</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/martillos.png" producto="Martillos"
					  	color="Azul" key={index} valor={2250} descuento={33}/>
					))}
				</div>
			</div>
		</div>
