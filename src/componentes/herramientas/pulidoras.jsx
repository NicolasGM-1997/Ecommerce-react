...
export function Pulidoras(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Pulidoras</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/pulidoras.png" producto="Pulidoras"
					  	color="Azul" key={index} valor={1250} descuento={33}/>
					))}
				</div>
			</div>
		</div>
