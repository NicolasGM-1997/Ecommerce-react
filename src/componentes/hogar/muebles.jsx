...
export function Muebles(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Muebles</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/muebles.png" producto="Muebles"
					  	color="Azul" key={index} valor={2050} descuento={19}/>
					))}
				</div>
			</div>
		</div>
