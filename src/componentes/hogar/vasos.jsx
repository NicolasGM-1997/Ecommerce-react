...
export function Vasos(){
	return(
		<div className="contenedor">
			<p className="tituloPagina">Todas Nuestros Productos</p>
			<p className="tituloProducto">Vasos</p>
			<div className="division">
				...
				<div className="productos">
					{Array.from({ length: 10 }, (_, index) => (
					  <CeldaDeProducto imagen="/src/img/categorias/vasos.png" producto="Vasos"
					  	color="Azul" key={index} valor={1500} descuento={13}/>
					))}
				</div>
			</div>
		</div>
